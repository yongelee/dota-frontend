...
let reducer = (state, action) => {
  switch (action.type) {
    case UPDATE_TOURNAMENTS_FROM_API:
      console.log(action.payload);
      const tournamentsUpdated = {};
      action.payload.tournaments.tournamentFormOptions.forEach((tourn) => {
        tournamentsUpdated[tourn.id] = {
          date: tourn.date,
          name: tourn.name,
          checked: false
        };
      ...
      return {
        ...state,
        tournaments: tournamentsUpdated
      };
...
export const UPDATE_TOURNAMENTS_FROM_API = "UPDATE_TOURNAMENTS_FROM_API";
